...
S310121-R091121_DEVEL0 - IOS - I/O Subsystem for the 68008 CPU (8MHz)
...
void main(void)
{
  ...
  printf("\r\n\n68k-MBC - A091020-R140221\r\nIOS - I/O Subsystem - S310121-R091121_DEVEL0\r\n\n");
...
inline void execWriteOpcode()
{
  ...
  // Execute the requested I/O WRITE Opcode. The 0xFF value is reserved as "No operation".
  {
    ...
    case  0x14:
      ...
      //
      // NOTE 1: Before a WRITELBA operation at least a SELLBA should be always performed
